...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/murakaa/somadorpod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'murakaa' => 'muraka.aline@gmail.com' }
  s.source           = { :git => 'https://github.com/murakaa/somadorpod.git', :tag => s.version.to_s }
